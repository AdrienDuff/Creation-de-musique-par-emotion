...
% Nous devons modifier y pour avoir à chaque exemple un 1 et que des zeros. Le 1 se situant au niveau du numéro de la classe auquel appartient l'exemple.
...
for k= 1:m
	...
	J = J - sum(yk'.*log(a{L}) + (1-yk').*log(1-a{L}));
